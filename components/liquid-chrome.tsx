...
export const LiquidChrome: React.FC<LiquidChromeProps> = ({
  ...
  useEffect(() => {
    ...
    // Throttle pointer updates to animation frames
    ...
    const applyPointer = () => {
      ...
      mouseUniform[0] = pendingPointer.x
      mouseUniform[1] = pendingPointer.y
      pendingPointer = null
    ...
    return () => {
      ...
      if (interactive) {
        ...
        // pointermove anonymous handler cannot be removed; acceptable since component unmounts and canvas removed
      }
